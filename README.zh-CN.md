...
**将 VS Code 转换为专业提词器。** 非常适合编程直播、技术演示、教育视频和专业内容创作。具有即时主题切换、自动滚屏控制和无干扰阅读体验。

## 🎯 什么是 CueMode？

CueMode 是下一代提词器扩展，可将您的 VS Code 编辑器转换为专业的提词器解决方案。现在具有**即时主题循环**、**增强型键盘快捷键**和**专业级功能**，专为开发者、教育工作者和内容创作者设计。

**✨ 2.1 版本功能：**

- **🎨 T 键主题循环** - 演示期间即时切换主题
- **🔍 F 键开关聚焦模式** - 聚焦当前阅读区域，模糊其余内容，支持自定义聚焦行数与不透明度，提升专注力
- **⚡ 增强命令** - 快速主题更改和文本预处理
- **📱 智能通知** - 非干扰性状态栏反馈
- **🌐 完整国际化** - 完整的中英文支持
