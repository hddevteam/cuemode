...
suite('ThemeManager Tests', () => {
  test('getTheme should return valid theme for all supported themes', () => {
    ...
    themes.forEach(themeName => {
      ...
      assert.ok(
        ...
        `Theme ${themeName} backgroundColor should be string`
      );
      assert.ok(
        typeof theme.textColor === 'string',
        `Theme ${themeName} textColor should be string`
      );
    });
  });
  ...
  test('getAllThemes should return all available themes', () => {
    ...
    const expectedThemes: ColorTheme[] = [
      'classic',
      'inverted',
      'midnightBlue',
      'sunset',
  ...
  test('classic theme should have expected colors', () => {
    ...
    assert.strictEqual(
      ...
      '#000000',
      'Classic theme should have black background'
    );
  ...
  test('inverted theme should have expected colors', () => {
    ...
    assert.strictEqual(
      theme.backgroundColor,
      '#ffffff',
      'Inverted theme should have white background'
    );
  ...
  test('getThemeNames should return all theme names', () => {
    ...
    const expectedNames: ColorTheme[] = [
      'classic',
      'inverted',
      'midnightBlue',
      'sunset',
  ...
  test('validateThemeAccessibility should validate all themes', () => {
    ...
    themes.forEach(themeName => {
      ...
      assert.ok(
        ...
        `Theme ${themeName} accessibility should return boolean`
      );
